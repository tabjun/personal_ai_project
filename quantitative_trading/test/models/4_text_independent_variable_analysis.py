...
def parse_args(argv: Iterable[str] | None = None) -> ExperimentConfig:
    ...
    parser.add_argument("--table", default="upbit_krw_candle", help="Candle table name.")
    ...
    parser.add_argument("--ticker", default="KRW-BTC", help="Optional ticker filter, e.g. KRW-BTC.")
